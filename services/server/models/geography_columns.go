...
var geographyColumnAfterSelectMu sync.Mutex
...
func AddGeographyColumnHook(hookPoint boil.HookPoint, geographyColumnHook GeographyColumnHook) {
	...
	case boil.AfterSelectHook:
		geographyColumnAfterSelectMu.Lock()
		geographyColumnAfterSelectHooks = append(geographyColumnAfterSelectHooks, geographyColumnHook)
		geographyColumnAfterSelectMu.Unlock()
	}
}

// OneG returns a single geographyColumn record from the query using the global executor.
func (q geographyColumnQuery) OneG(ctx context.Context) (*GeographyColumn, error) {
...
// AllG returns all GeographyColumn records from the query using the global executor.
func (q geographyColumnQuery) AllG(ctx context.Context) (GeographyColumnSlice, error) {
...
// CountG returns the count of all GeographyColumn records in the query using the global executor
func (q geographyColumnQuery) CountG(ctx context.Context) (int64, error) {
...
func (q geographyColumnQuery) ExistsG(ctx context.Context) (bool, error) {
